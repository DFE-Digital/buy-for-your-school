class RevertHostedDevSchoolsFromTestingMspStatusFilter < ActiveRecord::Migration[7.1]
  def up
    if ENV["APPLICATION_URL"] == "https://dev.get-help-buying-for-schools.service.gov.uk"
      # Revert United Learning Trust's following schools back to their true status:
