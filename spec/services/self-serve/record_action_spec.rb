      ...
      it "raises a rollbar event" do
        expect(Rollbar).to receive(:warning)
          .with(
            ...
            data: nil,
            allowed_action_types: "begin_journey, view_journey, begin_task, view_task, begin_step, view_step, save_answer, acknowledge_statement, update_answer, view_specification",
          ).and_call_original
