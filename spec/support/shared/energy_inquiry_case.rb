RSpec.shared_context "with energy inquiry case" do
  ...
  context "when the case is an energy for schools case" do
    ...
    context "when the case is energy sub_category" do
      ...
      # Idea here is to ensure that the change links are not present for energy onboarding cases which is a L7 case
      ...
      # but are present for energy inquiry cases which is a L6 case.
