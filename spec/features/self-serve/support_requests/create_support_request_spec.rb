RSpec.feature "Create a new support request" do
  ...
  # TODO: test context
  # context "when the user is signed in without an existing spec" do
  # end

  context "when the user is signed in with an existing spec" do
    before do
      user_is_signed_in(user: journey.user)
      visit "/users/#{user.id}/support-requests"
    end

    specify { expect(page).to have_current_path "/users/#{user.id}/support-requests" }
    ...
    it "links to more information" do
      expect(page).to have_link "read about writing a specification",
                                href: "https://buy-for-your-school-staging.herokuapp.com/beta/phase-5/gov/buying-procedures-for-schools-writing-a-spec",
                                class: "govuk-link"

      expect(page).to have_link "planning for what you're buying",
                                href: "https://buy-for-your-school-staging.herokuapp.com/beta/phase-5/gov/buying-procedures-for-schools",
                                class: "govuk-link"

      expect(page).to have_link "information on finding the right way to buy",
                                href: "https://buy-for-your-school-staging.herokuapp.com/beta/phase-5/gov/buying-for-schools",
                                class: "govuk-link"
