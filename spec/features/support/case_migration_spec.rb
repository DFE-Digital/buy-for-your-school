  ...
  context "with valid data" do
    ...
    context "with valid data" do
      it "validates a phone number (valid 0)" do
        valid_form_data
        fill_in "case_hub_migration_form[phone_number]", with: "01234567890"
        click_on "Save and continue"
        click_on "Create case"
        expect(find("h3#case-ref")).to have_text "000001"
      end
      ...
      it "validates a phone number (valid +44)" do
        valid_form_data
        fill_in "case_hub_migration_form[phone_number]", with: "+441234567890"
        click_on "Save and continue"
        click_on "Create case"
        expect(find("h3#case-ref")).to have_text "000001"
      end
    ...
    context "with invalid data it validates a phone number" do
      it "(min size)" do
        fill_in "case_hub_migration_form[phone_number]", with: "0123"
        click_on "Save and continue"
        expect(find("h2.govuk-error-summary__title")).to have_text "There is a problem"
        expect(page).to have_link "Phone number must have no spaces and begin with a 0 or +44, with a minimum of 10 and maximum 12 digits", href: "#case-hub-migration-form-phone-number-field-error"
      ...
      it "(international code)" do
        fill_in "case_hub_migration_form[phone_number]", with: "+3551234567"
        click_on "Save and continue"
        expect(find("h2.govuk-error-summary__title")).to have_text "There is a problem"
        expect(page).to have_link "Phone number must have no spaces and begin with a 0 or +44, with a minimum of 10 and maximum 12 digits", href: "#case-hub-migration-form-phone-number-field-error"
        within "div.govuk-error-summary__body" do
      ...
      it "(white space)" do
        fill_in "case_hub_migration_form[phone_number]", with: "0208 590 1465"
        click_on "Save and continue"
        expect(find("h2.govuk-error-summary__title")).to have_text "There is a problem"
        expect(page).to have_link "Phone number must have no spaces and begin with a 0 or +44, with a minimum of 10 and maximum 12 digits", href: "#case-hub-migration-form-phone-number-field-error"
        within "div.govuk-error-summary__body" do
      ...
      it "(leading zero)" do
        fill_in "case_hub_migration_form[phone_number]", with: "11234567890"
        click_on "Save and continue"
        expect(find("h2.govuk-error-summary__title")).to have_text "There is a problem"
        expect(page).to have_link "Phone number must have no spaces and begin with a 0 or +44, with a minimum of 10 and maximum 12 digits", href: "#case-hub-migration-form-phone-number-field-error"
        within "div.govuk-error-summary__body" do
      ...
      it "(only numbers)" do
        fill_in "case_hub_migration_form[phone_number]", with: "0123456789x"
        click_on "Save and continue"
        expect(find("h2.govuk-error-summary__title")).to have_text "There is a problem"
        expect(page).to have_link "Phone number must have no spaces and begin with a 0 or +44, with a minimum of 10 and maximum 12 digits", href: "#case-hub-migration-form-phone-number-field-error"
        within "div.govuk-error-summary__body" do
      ...
      it "(max size)" do
        fill_in "case_hub_migration_form[phone_number]", with: "+4412345678901343"
        click_on "Save and continue"
        expect(find("h2.govuk-error-summary__title")).to have_text "There is a problem"
        expect(page).to have_link "Phone number can not have more than 12 digits", href: "#case-hub-migration-form-phone-number-field-error"
        within "div.govuk-error-summary__body" do
