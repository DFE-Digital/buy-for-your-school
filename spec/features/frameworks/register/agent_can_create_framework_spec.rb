...
describe "Agent can create frameworks", js: true do
  ...
  it "creates and takes you to the new framework" do
    ...
    within "fieldset", text: "DfE Ownership" do
      fill_in "SCT Framework Owner", with: "John Smith"
      fill_in "SCT Framework Provider Lead", with: "Jane Doe"
    ...
    expect(page).to have_summary("SCT Framework Owner", "John Smith")
    expect(page).to have_summary("SCT Framework Provider Lead", "Jane Doe")
