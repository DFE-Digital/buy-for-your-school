...
describe "Uploading energy bills" do
  it "saves the uploaded files as pending records" do
    post bill_uploads_upload_framework_requests_path, params: { file: fixture_file_upload("text-file.txt") }
  ...
  it "removes energy bills" do
    ...
    delete bill_uploads_remove_framework_requests_path, params: { file_id: energy_bill.id }
