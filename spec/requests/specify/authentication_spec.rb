  ...
  describe "Sign out" do
    ...
    context "when there is a sign out token" do
      ...
      it "redirects to the issuer with token and return redirect params" do
        ...
        delete "/auth/dfe/signout"
        expect(response).to redirect_to "https://test-oidc.signin.education.gov.uk/session/end?#{{ id_token_hint: nil, post_logout_redirect_uri: 'http://www.example.com/auth/dfe/signout' }.to_query}"
      end
    end
  end
