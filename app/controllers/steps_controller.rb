...
class StepsController < ApplicationController
  ...
  def update
    ...
    return redirect_to journey_task_path(journey, parent_task, last_step: true) if @step.id == parent_task.skipped_ids.last
    ...
    elsif parent_task.steps.visible.last == @step
