class ExitSurvey::SatisfactionReasonController < ApplicationController
  ...
  def edit
    @form = ExitSurvey::SatisfactionReasonForm.new(**exit_survey_response.to_h)
    @back_url = edit_exit_survey_satisfaction_path
  end
...
private
  ...
  def validation
    @validation ||= ExitSurvey::SatisfactionReasonFormSchema.new.call(**form_params)
  end
end
