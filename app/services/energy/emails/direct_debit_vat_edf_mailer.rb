module Energy
  class Emails::DirectDebitVatEdfMailer
    DD_VAT_EDF_EMAIL_TEMPLATE = "DD and VAT email - electricity".freeze
  ...
  private
    ...
    def email_template
      @email_template ||= Support::EmailTemplate.find_by(title: DD_VAT_EDF_EMAIL_TEMPLATE, archived: false)
    end
