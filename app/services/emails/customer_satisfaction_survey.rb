...
private
  ...
  def satisfaction_level_links
    ...
    satisfaction_levels.each { |k, _v| links["#{k}_link"] = Rails.application.routes.url_helpers.edit_customer_satisfaction_surveys_satisfaction_level_url(@survey_id, customer_satisfaction_survey: { satisfaction_level: k.to_s }) }
