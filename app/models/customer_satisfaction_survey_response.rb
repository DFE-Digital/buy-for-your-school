class CustomerSatisfactionSurveyResponse < ApplicationRecord
  ...
  enum :service, { find_a_framework: 0, create_a_spec: 1, supported_journey: 2, request_for_help_form: 3, energy_for_schools: 4, find_a_buying_solution: 5 }, prefix: true
  enum :source, { exit_survey: 0, banner_link: 1, sidebar_link: 2, confirmation_screen: 3, footer_link: 3 }, prefix: true
