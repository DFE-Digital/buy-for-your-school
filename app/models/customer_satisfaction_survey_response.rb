class CustomerSatisfactionSurveyResponse < ApplicationRecord
  ...
  enum :service, { find_a_framework: 0, create_a_spec: 1, supported_journey: 2, request_for_help_form: 3, find_a_buying_solution: 4 }, prefix: true
  enum :source, { exit_survey: 0, banner_link: 1, sidebar_link: 2, footer_link: 3 }, prefix: true
